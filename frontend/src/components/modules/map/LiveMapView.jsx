...
export function LiveMapView({ embedded = false }) {
  ...
  return (
    <div
      className={embedded ? "relative" : "relative -mx-4"}
      style={embedded ? { height: "calc(100vh - 220px)" } : undefined}
    >
      ...
      <div
        ...
        style={{ height: embedded ? "100%" : "calc(100vh - 3.5rem)" }}
