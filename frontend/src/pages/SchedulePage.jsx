  ...
  const slides = [
    {
      ...
      content: (
        <div className="space-y-4 p-1">
          <div>
            <h2 className="text-xl font-bold text-slate-900 dark:text-foreground flex items-center gap-2">
    ...
    return (
      <div className="-mx-4 space-y-0">
        <div className="px-4 py-3 border-b border-slate-200 flex items-center justify-between">
          <div>
            <h1 className="text-lg font-bold text-slate-900 dark:text-foreground flex items-center gap-2">
